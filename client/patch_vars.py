...
with open('src/modules/common/landing.css', 'r', encoding='utf-8') as f:
    content = f.read()
...
# Update .lp-light
content = re.sub(r'\.lp-light\s*\{[^}]+\}', new_light, content, count=1)

with open('src/modules/common/landing.css', 'w', encoding='utf-8') as f:
    f.write(content)
print("Updated CSS Theme Variables successfully!")
