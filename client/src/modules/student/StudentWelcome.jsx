      ...
      <div className="st-mobile-frame entrance-animation">
        <main className="st-welcome-main">
          ...
          <div className="pt-2 px-6">
            <Link to="/" className="text-slate-400 hover:text-primary transition-colors flex items-center gap-2 text-[11px] uppercase font-black tracking-[0.15em] no-underline">
